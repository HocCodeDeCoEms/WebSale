						...
						<ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-5 px-2 text-success border border-start-0 border-end-0 border-success bg-success-subtle">
							...
							<!-- <?php
								if(isset($_SESSION['username'])&&($_SESSION['username']!="")){
									echo '<li class="nav-item border-success"> <a class="nav-link text-success fw-medium" href="indexs.php?act=userinfo">'.$_SESSION('username').'</a></li>';
								} else{
							?>
							<li class="nav-item border-success">
								<a class="nav-link text-success fw-medium" href="login.php">Đăng nhập</a>
							</li>
							<li class="nav-item">
								<a class="nav-link text-success fw-medium" href="register.php">Đăng ký</a>
							</li>
							<?php } ?> -->
